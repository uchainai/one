...
function ResNav() {
  ...
  return (
    <div>
      <div className='bg-orange-600 w-5xl text-white sticky top-0 z-10 sm:w-full motion-preset-slide-up-md motion-duration-75 motion-delay-75 '>
        <div className='header max-w-5xl mx-auto p-4 flex justify-between sm:justify-between sm:w-full items-center'>

          <h1 className='text-xl flex gap-2 hover:animate-bounce duration-75 cursor-pointer '> HOTEL-RESORTs <FaHotel className='text-2xl font-serif hover:font-bold cursor-pointer' /></h1>
          <button    className='btn text-2xl sm:hidden focus:outline-none focus:'>
            <BiAlignRight  onClick={toggleMenu} />
          </button>
          <nav className="hidden text-xl space-x-10 md:mx-2 sm:block  ">
