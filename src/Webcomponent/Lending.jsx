...
function Lending() {
    return (
        <div>
            <div class="h-screen overflow-y-auto bg-gray-700 text-white">
                ...
                <main class="mx-auto max-w-4xl overflow-x-hidden px-8 py-4">
                    ...
                    <div class="mt-10 flex flex-col gap-10 sm:flex-row sm:gap-4">
                        <div class="motion motion-preset-slide-left flex-1 rounded-2xl bg-lime-800/50 p-4 motion-delay-[1000ms] motion-ease-spring-bouncier">
                            <img alt="shopify logo" class="-mt-12 mb-4 size-20 bg-blend-exclusion" src="https://cdn.sanity.io/images/xrq4swux/production/ea11cf5ade02dbf180e5a8c277a281141d58d6f4-110x124.svg?fit=max&auto=format" />
                        ...
                        <div class="motion motion-preset-slide-left flex-1 rounded-2xl bg-teal-800/50 p-4 motion-delay-[1300ms] motion-ease-spring-bouncier">
                            <img alt="tailwind logo" class="-mt-12 mb-4 size-20 opacity-90 bg-blend-exclusion" src="https://cdn.sanity.io/images/xrq4swux/production/49f386e7cb98664a6645577735448c1062daeb57-54x33.svg?fit=max&auto=format" />
                        ...
                        <div class="motion motion-preset-slide-left flex-1 rounded-2xl bg-gray-800/50 p-4 motion-delay-[1600ms] motion-ease-spring-bouncier">
                            <img alt="figma logo" class="-mt-12 mb-4 size-20 opacity-90 bg-blend-exclusion" src="https://cdn.sanity.io/images/xrq4swux/production/8ba9090052032bc90e8cfa9a83583fdf69c7d96b-413x620.svg?fit=max&auto=format" />
